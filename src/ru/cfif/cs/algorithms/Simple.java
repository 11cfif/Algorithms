...
public class Simple {
	public static void main(String[] args) {
		...
		// Random variables
		String randomFrom = "ASkjklasdlkjasdkljdas;lASd ;lasd kj;l"; // Некоторая случайная строка. Можете выбрать ее самостоятельно.
		String randomTo = "sd;lfks;ldf';l ;ldsf ;l";  // Некоторая случайная строка. Можете выбрать ее самостоятельно.
